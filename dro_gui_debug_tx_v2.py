...
from manuale_v3 import ManualeFrame
...
class DROApp(tk.Tk):
    def __init__(self):
        ...
        self.start_serial()
        self.frame = ManualeFrame(self, on_back=self.destroy, get_axis_values=lambda: self.positions,
    ...
    def send_manual_command(self, data):
        ...
        line = f'JOG,X:{self.last_manual_cmd["x"]:.1f},Y:{self.last_manual_cmd["y"]:.1f},Z:{self.last_manual_cmd["z"]:.1f}\\n'
        print("TX>", line.strip())
