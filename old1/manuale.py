...
class ManualeFrame(tk.Frame):
    def __init__(self, master, on_back, get_axis_values, on_manual_command=None, *args, **kwargs):
        ...
        self.xy_speed_var = tk.StringVar(value="X=+0.000   Y=+0.000")
        self.z_speed_var = tk.StringVar(value="Z=+0.000")
    ...
    def build_ui(self):
        ...
        hint = tk.Label(
            bottom,
            text="Trascina il joystick XY o il cursore Z. Rilasciando, il comando torna al centro.",
            font=("Arial", 18),
            fg="#cfcfcf",
            bg="#101010",
        )
    ...
    def publish_manual_command(self):
        ...
        self.xy_speed_var.set(f"X={vx:+0.3f}   Y={vy:+0.3f}")
        self.z_speed_var.set(f"Z={vz:+0.3f}")
